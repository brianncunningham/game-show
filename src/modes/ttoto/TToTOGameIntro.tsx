...
const INTRO_CSS = `
  ...
  .ttoto-w-this .key { display:inline-block; color:#e0625f; animation: ttotoKeyPulse 260ms ease-out 750ms both; }
  .ttoto-w-this .rest { display:inline-block; animation: ttotoDimRest 260ms ease-out 750ms forwards; }
  .ttoto-w-that .key { display:inline-block; color:#ffb020; animation: ttotoKeyPulse 260ms ease-out 750ms both; }
  ...
  .ttoto-k-other{ animation: ttotoKeyPulse 220ms ease-out 1600ms both; color:#3ec2d9; }
  ...
  .ttoto-wm-1 { color:#e0625f; animation: ttotoWmDropIn 500ms cubic-bezier(.22,1.05,.3,1) 950ms forwards; }
  .ttoto-wm-2 { color:#ffb020; animation: ttotoWmDropIn 500ms cubic-bezier(.22,1.05,.3,1) 2550ms forwards; }
  ...
  .ttoto-wm-5 { color:#3ec2d9; animation: ttotoWmDropIn 500ms cubic-bezier(.22,1.05,.3,1) 4900ms forwards; }
  ...
  .ttoto-intro-divider { position:absolute; top:740px; left:50%; transform:translateX(-50%) scaleX(0); width:340px; height:4px; background:linear-gradient(90deg, #e0625f, #ffb020, #3ec2d9); border-radius:2px; opacity:0; animation: ttotoWipeIn 600ms cubic-bezier(.3,.8,.3,1) 6050ms forwards; }
      ...
      <div style={{
        ...
        <div style={{
          position: 'absolute', inset: 0, backgroundImage:
            'radial-gradient(circle at 10% 90%, rgba(224,98,95,0.22), transparent 46%),' +
            'radial-gradient(circle at 90% 10%, rgba(255,176,32,0.22), transparent 46%),' +
            'radial-gradient(circle at 92% 90%, rgba(62,194,217,0.20), transparent 42%),' +
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 10, background: 'linear-gradient(90deg, #e0625f, #ffb020, #3ec2d9)', boxShadow: '0 0 22px rgba(255,176,32,0.35)' }} />
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 10, background: 'linear-gradient(90deg, #3ec2d9, #ffb020, #e0625f)', boxShadow: '0 0 22px rgba(255,176,32,0.35)' }} />
        ...
        <div className="ttoto-intro-icon-wrap settled">
          <svg width="130" height="130" viewBox="0 0 64 64">
            <g strokeWidth={7} strokeLinecap="round" fill="none">
              <g className="ttoto-blade ttoto-blade-1"><path d="M14 12 L34 32 L14 52" stroke="#e0625f" transform="rotate(0 32 32)" /></g>
              <g className="ttoto-blade ttoto-blade-2"><path d="M14 12 L34 32 L14 52" stroke="#ffb020" transform="rotate(120 32 32)" /></g>
              <g className="ttoto-blade ttoto-blade-3"><path d="M14 12 L34 32 L14 52" stroke="#3ec2d9" transform="rotate(240 32 32)" /></g>
            </g>
          </svg>
        </div>
