// Straight port of Survey Says's SSPlayerRosterModal.tsx — a shared cross-mode "known
// players" pick-list (same known-players.json file every mode reads/writes) so a host
// who already typed names into another mode this session doesn't have to retype them.
...
export const TToTOPlayerRosterModal = ({ open, currentPool, onClose, onApply }: Props) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Player pool — pick up to {MAX_POOL}</DialogTitle>
      <DialogContent>
...
export default TToTOPlayerRosterModal;
